...
// import { RxDiscordLogo } from 'react-icons/rx'; // Removed
...
const SidePanel = () => {
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden" data-theme={isDarkMode ? 'dark' : 'light'}>
      <div className="noise-bg" />
      <div className="flex h-screen flex-col overflow-hidden relative z-10">
        <header className="header">
          <div className="header-logo">
            {showHistory ? (
              <button
                ...
                <span>←</span> {t('nav_back')}
              </button>
            ) : (
              <div className="flex items-center space-x-2">
                <div className="h-6 w-6 logo-box text-xs">R</div>
                <span className="font-semibold text-primary">Rankify</span>
              </div>
            )}
          </div>
          <div className="header-icons">
            ...
            <a
              href="https://github.com/namandhakad712/Rankify-Assist"
              target="_blank"
        ...
        {showHistory ? (
          ...
          <>
            ...
            {hasConfiguredModels === null && (
              <div
                className="flex flex-1 items-center justify-center p-8 text-secondary">
                <div className="text-center">
                  <div className="mx-auto mb-4 size-8 animate-spin rounded-full border-2 border-accent-fill border-t-transparent"></div>
            ...
            {hasConfiguredModels === false && (
              <div
                ...
                <div className="max-w-md w-full">
                  <img src="/icon-128.png" alt="Rankify" className="mx-auto mb-6 h-28 w-auto drop-shadow-2xl hover:scale-105 transition-transform duration-300" />
                  <h3 className="mb-4 text-2xl font-bold text-primary">
                    {t('welcome_title')}
                  </h3>
                  <p className="mb-8 text-lg font-medium text-primary/90 leading-relaxed px-6">{t('welcome_instruction')}</p>
                  <button
                    onClick={() => chrome.runtime.openOptionsPage()}
                  ...
                  <div className="mt-8 text-sm opacity-75">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-indigo-400 font-medium hover:text-indigo-500 transition-colors">
            ...
            {hasConfiguredModels === true && (
              <>
                {messages.length === 0 && (
                  <>
                    <div className="chat-input-container mb-2 shadow-sm">
                      <ChatInput
                ...
                {messages.length > 0 && (
                  <div className="chat-input-container shadow-sm">
                    <ChatInput
                      onSendMessage={handleSendMessage}
                      onStopTask={handleStopTask}
                      onMicClick={handleMicClick}
