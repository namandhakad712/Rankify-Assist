...
## Node 8: End (Already There ✅)

**Auto-created** - Just needs all paths to connect to it.
...
2. **Middle dot (iot)** → Drag to IoT Output node
3. **Bottom dot (chat)** → Drag to Chat LLM node
