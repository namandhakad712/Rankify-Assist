...
async def main():
    ...
    logger.info("=" * 60)
    logger.info("Tuya MCP SDK Client - Simple Version")
    logger.info("=" * 60)
...
if __name__ == "__main__":
    print("\n🚀 Starting Tuya MCP Client for Browser Automation...")
    print("Make sure FastMCP server is running on http://localhost:8767\n")
    asyncio.run(main())
